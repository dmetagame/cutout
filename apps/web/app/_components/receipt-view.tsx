...
export function ReceiptView({ receiptId }: { readonly receiptId: string }) {
  ...
  return (
    <div ref={motionScope} className="app-frame motion-root">
      <a className="skip-link" href="#main-content">Skip to main content</a>
      <header className="app-header" data-receipt-reveal><div className="brand" translate="no"><span className="brand-mark"><ReceiptText size={17} aria-hidden="true" /></span><span>CUTOUT</span><span className="brand-divider" /><span className="brand-context">Public receipt</span></div><span className="network-pill"><CheckCircle2 size={13} aria-hidden="true" /> Verified public receipt</span></header>
